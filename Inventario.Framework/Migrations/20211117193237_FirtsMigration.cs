        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Procesador = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    ...
                    Disco = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    Serial = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Equipos_Accesorios_AccesorioId",
                        column: x => x.AccesorioId,
                        principalTable: "Accesorios",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Equipos_Asignaciones_AsignacionId",
                        column: x => x.AsignacionId,
                        principalTable: "Asignaciones",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Equipos_Empleados_EmpleadoId",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Equipos_Monitores_MonitorId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SalidaEquipos", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SalidaEquipos_Equipos_EquipoId",
                        column: x => x.EquipoId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Equipos_AccesorioId",
                table: "Equipos",
                column: "AccesorioId");

            migrationBuilder.CreateIndex(
                name: "IX_Equipos_AsignacionId",
                table: "Equipos",
                column: "AsignacionId");

            migrationBuilder.CreateIndex(
                name: "IX_Equipos_EmpleadoId",
                table: "Equipos",
                column: "EmpleadoId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Equipos_MonitorId",
                table: "Equipos",
                column: "MonitorId");

            migrationBuilder.CreateIndex(
                name: "IX_SalidaEquipos_EquipoId",
                table: "SalidaEquipos",
                column: "EquipoId");
        }
